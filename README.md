...
La v0.8.11 mantiene i **due trasporti indipendenti** della v0.8.2 e porta l'updater Android allo stesso flusso esplicito usato da HermesHub:
...
APK disponibile: **`dist/mcp-android-0.8.11-debug.apk`**, con SHA-256 nel file accanto. È una build debug firmata per installazione personale, non una release Play Store.
...
La v0.8.11 conserva la modalità ultra-low-power della v0.7.2 e il dual transport event-driven:
